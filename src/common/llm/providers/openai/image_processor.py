...
class OpenAiImageProcessor(BaseImageProcessor):
    """Image processor for OpenAI's API format."""

    def encode_image(self, image_bytes: bytes) -> str:
        """Encode image bytes as a base64 data URL for OpenAI's API."""
        logger.debug("Encoding image for OpenAI provider")
        return (
